	        ...
	        <div class="triple_col">
	            <div class="input_group">
	                <label><span class="star">*</span>Серия паспорта</label>
	                    <input type="text"  name="UF_PASSPORT_SERIAL" value="<?=$arResult["USER_PROPERTIES"]["DATA"]["UF_PASSPORT_SERIAL"]["VALUE"]?>"  class="req">
	                </div>
	        </div>
	        <div class="triple_col">
	            <div class="input_group">
	                <label><span class="star">*</span>Номер паспорта</label>
	                <input type="text"  name="UF_PASSPORT_NUMBER" value="<?=$arResult["USER_PROPERTIES"]["DATA"]["UF_PASSPORT_NUMBER"]["VALUE"]?>"  class="req">
	    ...
	    <div class="form_row">
	        <div class="dual_col">
	            <div class="input_group">
	                ...
	                <textarea name="UF_PASSPORT_FROM" rows="3"><?=$arResult["USER_PROPERTIES"]["DATA"]["UF_PASSPORT_FROM"]["VALUE"]?></textarea>
	            </div>
	        </div>
	        ...
	        <div class="dual_col">
	            <div class="input_group">
	                ...
	                <input type="text"  name="UF_PASSPORT_FCODE" value="<?=$arResult["USER_PROPERTIES"]["DATA"]["UF_PASSPORT_FCODE"]["VALUE"]?>"  class="req">
	            </div>
	            <div class="input_group">
	                <label><span class="star">*</span>Когда выдан</label>
	                <input type="text"  name="UF_PASSPORT_GIVE" value="<?=$arResult["USER_PROPERTIES"]["DATA"]["UF_PASSPORT_GIVE"]["VALUE"]?>"  class="req">
	            </div>
	        </div>
	    ...
	    <div class="form_row">
	        <div class="dual_col">
	            <div class="input_group">
	                ...
	                <input type="text" name="PERSONAL_BIRTHDAY" value="<?=$arResult["arUser"]["PERSONAL_BIRTHDAY"]?>"   class="req">
	            </div>
	        ...
	        <div class="dual_col">
	            ...
	            <div class="input_group">
	                ...
	                <textarea name="UF_ADDRESS_REG" rows="3"><?=$arResult["USER_PROPERTIES"]["DATA"]["UF_ADDRESS_REG"]["VALUE"]?></textarea>
	            </div>
	        </div>
        ...
        <div class="form_row">
            <div class="dual_col">
                <div class="input_group">
                    ...
                    <input type="text" name="WORK_COMPANY" value="<?=$arResult["arUser"]["WORK_COMPANY"]?>"  class="req">
                </div>
            </div>
            <div class="dual_col">
                <div class="input_group">
