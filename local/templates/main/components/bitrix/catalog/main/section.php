...
if(intval($_REQUEST['PAGE_COUNT']) > 0) 
	$_SESSION['pageCount'] = intval($_REQUEST['PAGE_COUNT']);

$pageCount = $_SESSION['pageCount'];



if(!in_array($pageCount, array(12, 24, 36, 48)))
 $pageCount = 36;
 

$arParams["PAGE_ELEMENT_COUNT"] = $pageCount;

if($_REQUEST['sort'] == 'name')
 $_SESSION['sort'] = 'NAME';

if($_REQUEST['sort'] == 'price')
 $_SESSION['sort'] = 'CATALOG_PRICE_2';
 
if(!in_array($_SESSION['sort'], array("NAME", "CATALOG_PRICE_2"))) 
 $_SESSION['sort'] = 'CATALOG_PRICE_2';
 
 
/* if($_REQUEST['order'] == 'DESC')
 $_SESSION['order'] = 'DESC';
elseif($_REQUEST['order'] == 'ASC') 
 $_SESSION['order'] = 'ASC'; */
 
   $_SESSION['order'] = (in_array($_REQUEST['order'], array('ASC', 'DESC'))) ? $_REQUEST['order'] : 'ASC';
...
$arParams["PRICE_CODE"] = array(0 => "Оптовая");
