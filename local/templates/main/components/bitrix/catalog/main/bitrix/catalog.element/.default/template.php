...
$is_vasa=false;
foreach ($arResult['PARENT_SECTIONS'] as $sec){
	if(in_array($sec['ID'],[106,107])) $is_vasa=true;
}
if($is_vasa):?>
	<strong>
			...
			<div class="catalog_item_price_block detail_price">
				...
				<div class="opt_prices">
					...
					<a href="javascript:void(0);" class="opt_prices_tip" style="height:35px; margin-top:13px;">
						...
						должна быть не менее, чем на 50 000 рублей в ценах "специальное предложение".</li>
