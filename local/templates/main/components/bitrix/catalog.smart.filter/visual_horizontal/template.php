        ...
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
            ...
            <div style="float: left;width: 35%  ">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    if (isset($arItem["PRICE"])):
                        if (!is_set($arItem["VALUES"]["MIN"]["VALUE"]) || !$arItem["VALUES"]["MAX"]["VALUE"] || $arItem["VALUES"]["MIN"]["VALUE"] == $arItem["VALUES"]["MAX"]["VALUE"])
                            continue;
                        ?>
                        <div class="bx_filter_parameters_box active">
                            <span class="bx_filter_container_modef"></span>
                            <div class="bx_filter_parameters_box_title"
                                 onclick="smartFilter.hideFilterProps(this)"><?= $arItem["NAME"].' цена:' ?></div>
                            <div class="bx_filter_block">
                                <div class="bx_filter_parameters_box_container">
                                    <div class="bx_filter_parameters_box_container_block">
                                        <div class="bx_filter_input_container">
                                            <?
                                            $count = (int)log10($arItem["VALUES"]["MAX"]["VALUE"]);
                                            $price5 = ceil($arItem["VALUES"]["MAX"]["VALUE"]/pow(10,$count-1))*pow(10,$count-1);
                                            $price1 = (floor($arItem["VALUES"]["MIN"]["VALUE"]/ pow(10,$count-1)))*pow(10,$count-1);
                                            $price2 = $price1 + ($price5 - $price1) / 4;
                                            $price3 = $price1 + ($price5 - $price1) / 2;
                                            $price4 = $price1 + ($price5 - $price1) *3/4;
                                            ?>
                                            <input
                                                class="min-price"
                                                type="text"
                                ...
                                <div class="bx_filter_parameters_box_container">
                                    <div class="bx_filter_parameters_box_container_block">
                                        <div class="bx_filter_input_container">
                                            ...
                                            $count = (int)log10($arItem["VALUES"]["MAX"]["VALUE"]);
                                            $price5 = ceil($arItem["VALUES"]["MAX"]["VALUE"]/pow(10,$count-1))*pow(10,$count-1);
                                            $price1 = (ceil($arItem["VALUES"]["MIN"]["VALUE"]/ pow(10,$count-1)))*pow(10,$count-1);
                                            $price2 = $price1 + ($price5 - $price1) / 4;
                                            $price3 = $price1 + ($price5 - $price1) / 2;
                                            $price4 = $price1 + ($price5 - $price1) *3/4;?>
                                            <input
            ...
            foreach ($arResult["ITEMS"] as $key => $arItem) {
                ...
                if (
                    ...
                    /*&& (
                        !is_set($arItem["VALUES"]["MIN"]["VALUE"])
                                ...
                                <div class="bx_filter_parameters_box_container_block">
                                    <div class="bx_filter_input_container">
                                        <input
                                            ...
                                            name="<? echo $arItem["VALUES"]["MIN"]["CONTROL_NAME"] ?>"
                                            id="<? echo $arItem["VALUES"]["MIN"]["CONTROL_ID"] ?>"
                                            value="<? echo $arItem["VALUES"]["MIN"]["HTML_VALUE"]?$price1:'' ?>"
                                            size="5"
                                            onkeyup="smartFilter.keyup(this)"
                                        />
                                    </div>
                                ...
                                <div class="bx_filter_parameters_box_container_block">
                                    <div class="bx_filter_input_container">
                                        <input
                                            ...
                                            name="<? echo $arItem["VALUES"]["MAX"]["CONTROL_NAME"] ?>"
                                            id="<? echo $arItem["VALUES"]["MAX"]["CONTROL_ID"] ?>"
                                            value="<?=$arItem["VALUES"]["MAX"]["HTML_VALUE"]?$price5:''?>"
                                            size="5"
                                            onkeyup="smartFilter.keyup(this)"
                                        />
                                    </div>
                            ...
                            ?>
                                <label class="bx_filter_param_label" for="<? echo "all_" . $arCur["CONTROL_ID"] ?>">
									<span class="bx_filter_input_checkbox">
                                        ...
                                        />
										<span
                                            class="bx_filter_param_text"><? echo GetMessage("CT_BCSF_FILTER_ALL"); ?></span>
									</span>
                                </label>
                                <? foreach ($arItem["VALUES"] as $val => $ar):?>
                                <label data-role="label_<?= $ar["CONTROL_ID"] ?>" class="bx_filter_param_label"
                                       for="<? echo $ar["CONTROL_ID"] ?>">
										<span
                                            class="bx_filter_input_checkbox <? echo $ar["DISABLED"] ? 'disabled' : '' ?>">
											<input
                                                type="radio"
                                                value="<? echo $ar["HTML_VALUE_ALT"] ?>"
