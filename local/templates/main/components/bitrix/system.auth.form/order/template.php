	...
	<div class="form_row">
		<div class="single_col">
			<div class="input_group">
				<label><span class="star"> </span>Логин</label>
				<input type="text" name="USER_LOGIN" maxlength="50" value="<?=$arResult["USER_LOGIN"]?>" size="17" style="width:225px" />
				<div class="note"></div>
			</div>
		</div>			 						
	</div>
...
<?endif?>
	...
	<input type="submit" name="Login" id="auth_form_button" class="button" value=" Войти и продолжить оформление заказа ">
	</div>
</div>
</form>
